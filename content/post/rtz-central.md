...
You need an [RTZ legal force]({{< ref "/post/rtz-force-create-build" >}}) to go on missions.
...
Ans: Start with this short series on the [history of the doomed city]({{< ref "/post/battle-for-zverograd-part-1" >}}) till start of campaign.
